...
console.log(registro.fechaHorneado)
...
const TempHornos = await pool.query(
  `SELECT * FROM temphornossolantec WHERE fecha_creacion=? AND id_horno=? AND id_turno=?`,[fechaHorneado,horno,turno]
)
const temperaturas = TempHornos[0] || [];
console.log('Datos Hornos', temperaturas,fechaHorneado,horno,turno );
