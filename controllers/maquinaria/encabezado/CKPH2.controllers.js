...
export const postCKPH2 = async(req, res)=>{
    const id_estado= 2;
    ...
    try{
       ...
       const consulta='INSERT INTO ckph2 (id_maquina, id_creador, id_estado)Values(?, ?, ?)';
...
export const putCKPH2 = async (req, res) => {
    ...
    try {
        if (estado === '' || id === '') {
            ...
            const consulta = 'UPDATE ckph2 SET id_estado = ?, fechaCierre = ?, horaCierre = ? WHERE id = ?';
